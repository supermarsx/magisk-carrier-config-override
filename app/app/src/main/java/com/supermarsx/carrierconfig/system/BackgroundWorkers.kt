...
class UpdateCheckWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        return try {
            val result = com.supermarsx.carrierconfig.util.UpdateChecker.checkForUpdates(applicationContext)
            
            when (result) {
                is com.supermarsx.carrierconfig.util.UpdateCheckResult.UpdateAvailable -> {
